...
* 熟练掌握`JavaScript`，对于数据类型、作用域、闭包、异步、原型、事件循环、继承有一定了解

* 熟练掌握`Vue2`、`Vue3`以及相关生态工具、UI组件库，包括但不限于`Vue-Router`、`VueX`、`Vue-Cli`、`Vite`、`Pinia`、`Element UI`、`Vant`......

* 善于集成构建工具、校验工具、测试工具、CI\CD持续集成、Git、UI组件库、工具库
、插件不断优化开发流程
*  对前端工程化有一定研究和理解
* 热衷于对产品进行性能、交互方面优化
...
* 根据项目类型（需求复杂度、迭代频率、研发周期）确定相关技术栈、开发流
* 维护、更新公司公共代码库（JSBridge、CLI、Hooks、常用方法、SDK、业务组件、脚手架）
